document.addEventListener('DOMContentLoaded', () => {
  const translations = {
    en: {
      ...
      'pose.triggers.event.start': '100 - Sequence start',
      'pose.triggers.event.pose': '210 - Pose complete',
    ...
    ja: {
      ...
      'pose.triggers.event.start': '100 - シーケンス開始',
      'pose.triggers.event.pose': '210 - ポーズ到達',
